...
@Entity
public class CaseSuperlativeSimpleAdjectiveUkr {
    ...
    public CaseSuperlativeSimpleAdjectiveUkr() {
    }
    ...
    public String toString() {
        return "CaseSuperlativeSimpleAdjectiveUkr{" +
                "id=" + id +
