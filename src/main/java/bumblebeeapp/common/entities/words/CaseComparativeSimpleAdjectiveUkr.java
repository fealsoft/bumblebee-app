...
@Entity
public class CaseComparativeSimpleAdjectiveUkr {
    ...
    public CaseComparativeSimpleAdjectiveUkr() {
    }
    ...
    public String toString() {
        return "CaseComparativeSimpleAdjectiveUkr{" +
                "id=" + id +
