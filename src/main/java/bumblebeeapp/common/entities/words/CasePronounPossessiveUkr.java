...
@Entity
public class CasePronounPossessiveUkr {
    ...
    public CasePronounPossessiveUkr() {
    }
    ...
    public String toString() {
        return "CasePronounPossessiveUkr{" +
                "id=" + id +
